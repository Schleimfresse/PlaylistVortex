 ...
 * @since v.1.0.0
 */
userInputHandler.retrymediatype = function (YTURL) {
  rl.question("".concat(colorCodes.bright, "Should the files have video and audio or only audio? (audio/video): ").concat(colorCodes.reset), /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(TYPE) {
        ...
        while (1) switch (_context2.prev = _context2.next) {
          ...
          case 3:
            rl.question("".concat(colorCodes.bright, "Should duplicates be removed? (true/false): ").concat(colorCodes.reset), /*#__PURE__*/function () {
              var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(DUPLICATE) {
 ...
 * @since v.1.0.0
 */
userInputHandler.retryurl = function () {
  rl.question("".concat(colorCodes.bright, "Paste your YouTube playlist link here: ").concat(colorCodes.reset), /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(YTURL) {
      return _regeneratorRuntime().wrap(function _callee5$(_context5) {
        while (1) switch (_context5.prev = _context5.next) {
          case 0:
            ...
            return _context5.abrupt("return", retryurl());
          case 3:
                ...
                return _regeneratorRuntime().wrap(function _callee4$(_context4) {
                  while (1) switch (_context4.prev = _context4.next) {
                    case 0:
                      ...
                      console.log("".concat(colorCodes.yellow, "Please enter valid values").concat(colorCodes.reset));
                      return _context4.abrupt("return", retrymediatype(YTURL));
                    case 3:
                      rl.question("".concat(colorCodes.bright, "Should duplicates be removed? (true/false): ").concat(colorCodes.reset), /*#__PURE__*/function () {
                        var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(DUPLICATE) {
                          return _regeneratorRuntime().wrap(function _callee3$(_context3) {
                            while (1) switch (_context3.prev = _context3.next) {
                              case 0:
                                ...
                                console.log("".concat(colorCodes.yellow, "Please enter a valid value").concat(colorCodes.reset));
                                return _context3.abrupt("return", retrydup());
                              case 3:
                                downloadPlaylist(String(YTURL), String(TYPE), JSON.parse(DUPLICATE));
                              case 4:
                              case "end":
 ...
 * @since v.1.3.0
 */
userInputHandler.retrydup = function (YTURL, TYPE) {
  rl.question("".concat(colorCodes.bright, "Should duplicates be removed? (true/false): ").concat(colorCodes.reset), /*#__PURE__*/function () {
    var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(DUPLICATE) {
      return _regeneratorRuntime().wrap(function _callee6$(_context6) {
        while (1) switch (_context6.prev = _context6.next) {
          case 0:
            ...
            console.log("".concat(colorCodes.yellow, "Please enter a valid value").concat(colorCodes.reset));
            return _context6.abrupt("return", userInputHandler.retrydup());
          case 3:
            downloadPlaylist(String(YTURL), String(TYPE), JSON.parse(DUPLICATE));
          case 4:
          case "end":
